-- Credits from https://github.com/ecosse3/nvim/blob/master/lua/config/lsp/utils/documentcolors.lua
-- This is a 100% copy and paste from the original source, thanks Ecosse3
local bit = require("bit")

function debounce_trailing(fn, ms, first)
