...
local lighten_col = require("settings.colorscheme.utils").change_hex_lightness
...
local highligths = {
  ...
  NeogitDiffAdd = { fg = colors.green, bg = lighten_col(colors.green, -37) },
  NeogitDiffAddHighlight = { fg = colors.green, bg = lighten_col(colors.green, -37) },
  NeogitDiffAddCursor = { bg = colors.one_bg, fg = colors.green },
  NeogitDiffDeletions = { fg = colors.red },
  NeogitDiffDelete = { bg = lighten_col(colors.red, -40), fg = colors.red },
  NeogitDiffDeleteHighlight = { bg = lighten_col(colors.red, -40), fg = colors.red },
