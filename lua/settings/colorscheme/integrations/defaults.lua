...
local theme = require("settings.colorscheme").get_theme_tb("base_16")

local generate_color = require("settings.colorscheme.utils").change_hex_lightness
...
local merge_tb = require("settings.colorscheme").merge_tb
defaults = merge_tb(defaults, require("settings.colorscheme").load_highlight("statusline"))

local hexify_ColorStrs = require("settings.colorscheme").turn_str_to_color
